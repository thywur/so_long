...
/*   Updated: 2024/01/31 16:55:03 by alermolo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long_bonus.h"

static int	map_rectangular(t_data *data)
{
	int	i;
...
static int	walls_ok(t_data *data)
{
	int	i;
	int	j;
...
static void	check_access(t_data *data, int i, int j)
{
...
static int	is_solvable(t_data *data)
{
	int	i;
	int	j;
